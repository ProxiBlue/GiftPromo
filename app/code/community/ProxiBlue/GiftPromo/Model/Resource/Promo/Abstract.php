 ...
 * */
abstract class ProxiBlue_GiftPromo_Model_Resource_Promo_Abstract extends Mage_Core_Model_Mysql4_Abstract
                ...
                foreach ($entityIds as $entityId) {
                    ...
                    if (($count % 1000) == 0) {
                        $adapter->insertOnDuplicate(
                            $this->getTable($entityInfo['associations_table']), $data,
