 ...
 *
 * */
abstract class ProxiBlue_GiftPromo_Model_Promo_Rule_Condition_Product_Abstract
    ...
    public function getValueAfterElementHtml()
    {
        ...
        if (!empty($image)) {
            $html = '<a href="javascript:void(0)" class="rule-chooser-trigger"><img src="' . $image
                . '" alt="" class="v-middle rule-chooser-trigger" title="' . Mage::helper('rule')->__('Open Chooser')
                . '" /></a>';
        }
